      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-2xl font-bold tracking-tight text-white">Medication History</h2>
          </div>
          <p className="text-sm text-slate-400 mt-1">
            Complete clinical chronological log of all your medication regimens and intake adherence records
          </p>
        </div>
        <button
          type="button"
      ...
      <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3 bg-slate-900/60 border border-slate-800 rounded-2xl p-3">
        ...
        <div className="relative min-w-[240px]">
          ...
          <input
            ...
            placeholder="Search by medicine name, form..."
