...
import { Pill, Shield, LogOut, User, Bell, MessageSquare, ChevronRight, Check, CheckCheck, AlertTriangle, AlertCircle, Info, X, Package, Bot, Sparkles } from 'lucide-react';
...
import { formatLocalTime, formatRelativeOrTime } from '../../utils/dateTime';
...
export const Header = () => {
  ...
  const formatAlertTime = (timestamp) => {
    return formatLocalTime(timestamp, { hour12: true });
  };
            ...
            {isAuthenticated && user ? (
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <Link
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-teal-500/10 hover:bg-teal-500/20 text-teal-300 border border-teal-500/30 hover:border-teal-500/50 transition-all text-xs font-semibold shadow-sm"
                >
                          ...
                          <>
                            <div className="p-3.5 border-b border-slate-800 bg-slate-950/80 flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-xs font-bold text-white">{t('notifications.title')}</span>
                              </div>
                              <div className="flex items-center gap-2">
                                {alerts.length > 0 && (
                                  <button
