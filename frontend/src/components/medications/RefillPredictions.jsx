...
export const RefillPredictions = () => {
  ...
  const formatDate = (dateStr) => {
    if (!dateStr) return '—';
    return formatLocalDate(dateStr) || dateStr;
  };
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-2xl font-bold tracking-tight text-white">{t('nav.viewRefillPredictions')}</h2>
          </div>
        ...
        >
          ...
          <span>{t('medications.recalculatePredictions')}</span>
        </button>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-slate-900/60 border border-slate-800 rounded-2xl p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-slate-400 font-medium">{t('medications.monitoredMedicines')}</div>
            </div>
          </div>
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-2xl p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-slate-400 font-medium">{t('medications.criticalRefills')}</div>
            </div>
          </div>
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-2xl p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-slate-400 font-medium">{t('medications.refillSoon')}</div>
            </div>
          </div>
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-2xl p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-slate-400 font-medium">{t('medications.adequateStock')}</div>
            </div>
          </div>
        </div>
      )}
