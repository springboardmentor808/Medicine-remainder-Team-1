...
export const Profile = () => {
  ...
  return (
    <div className="space-y-8 w-full">
      {/* Header */}
      <div>
        <h2 className="text-2xl font-bold tracking-tight text-white">{t('settings.title')}</h2>
        <p className="text-sm text-slate-400 mt-1">
          {t('settings.subtitle')}
        </p>
      </div>

      {/* Language & Regional Preferences Card (Settings) */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-slate-900/60 border border-slate-800 rounded-2xl p-6 space-y-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base font-semibold text-white">{t('settings.personalInformation')}</h3>
          ...
          <form onSubmit={handleUpdateName} className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2 pt-2 border-t border-slate-800/80">
              <div>
                <span className="block text-[11px] font-medium text-slate-400">{t('auth.roleLabel')}</span>
                <span
              ...
              <div>
                <span className="block text-[11px] font-medium text-slate-400">{t('common.status')}</span>
