  ...
  return (
    <div className="space-y-6 w-full">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-white">Medications</h2>
          <p className="text-sm text-slate-400 mt-1">
            Manage your active medicine inventory, clinical dosages, and intake schedules
          </p>
        </div>
        <button
          type="button"
      ...
      <div className="flex items-center gap-2">
        ...
        >
          All Medicines (Including Discontinued)
        </button>
      </div>
